...
def main():
    ...
    restore_chk_path = 'checkpoint/v2/best_epoch_359/model_0.pd'
    seg_chk_path = 'checkpoint/v2/best_epoch_359/model_1.pd'
    cls_chk_path = 'checkpoint/v2/best_epoch_359/model_2.pd'
