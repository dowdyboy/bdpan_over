...
from bdpan_over.v2.dataset import OverDataset
from bdpan_over.v2.model import OverRestoreModelV2, OverSegmentModelV2, OverClassifyModelV2
from bdpan_over.v2.loss import RestoreLoss, ClassifyLoss, SegLoss
...
def build_model():
    restore_model = OverRestoreModelV2()
    seg_model = OverSegmentModelV2()
    cls_model = OverClassifyModelV2()
