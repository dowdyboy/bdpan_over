...
from bdpan_over.v5.dataset import OverDataset
from bdpan_over.v5.model import OverRestoreSegmentModelV5
from bdpan_over.v5.loss import RestoreSegmentLoss


parser = argparse.ArgumentParser(description='over net train v5')
# model config
...
def build_model():
    restore_model = OverRestoreSegmentModelV5(
...
def main():
    ...
    restore_loss_func = RestoreSegmentLoss(
        (args.train_data_size // args.batch_size) * 20
    )
