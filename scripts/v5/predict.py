...
from bdpan_over.v5.dataset import OverTestDataset
from bdpan_over.v4.model import OverClassifyModelV4
from bdpan_over.v5.model import OverRestoreSegmentModelV5
...
def build_model():
    restore_model = OverRestoreSegmentModelV5(is_pretrain=False)
...
def main():
    ...
    restore_chk_path = 'checkpoint/v5/restore_epoch_91/model_0.pd'
