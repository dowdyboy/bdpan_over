...
class OverModelEncoderV4(nn.Layer):
    ...
    def __init__(self,
        ...
        super(OverModelEncoderV4, self).__init__()
        self.scales = scales
...
class OverModelDecoderV4(nn.Layer):

    def __init__(self, feats_in_channel=[24, 24, 48, 96, 192], out_channel=16, ):
        super(OverModelDecoderV4, self).__init__()
...
class OverModelHeadV4(nn.Layer):

    def __init__(self, in_channel=16, num_classes=2, use_drop=True,):
        super(OverModelHeadV4, self).__init__()
...
class OverClassifyModelV4(nn.Layer):

    def __init__(self, num_classes=2, is_pretrain=True):
        super(OverClassifyModelV4, self).__init__()
...
class OverSegmentModelV4(nn.Layer):

    def __init__(self, is_pretrain=True):
        super(OverSegmentModelV4, self).__init__()
        self.encoder = OverModelEncoderV4(
            scales=['0.25', '0.33', '0.5'],
            feats_out_channel=[24, 24, 32, 64, 128],
            num_classes=2,
            is_pretrain=is_pretrain,
        )
        self.decoder = OverModelDecoderV4(
            feats_in_channel=[24, 24, 32, 64, 128],
            out_channel=16,
        )
        self.head = OverModelHeadV4(
            in_channel=16,
            num_classes=2,
            use_drop=True,
        )
...
class OverRestoreModelV4(nn.Layer):

    def __init__(self, is_pretrain=True, use_sigmoid=False):
        super(OverRestoreModelV4, self).__init__()
